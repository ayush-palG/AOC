...
/*
  TODO:
  Watch this video to devise a better algorithm for
  this problem, which doesn't take use this much memory 
  https://www.youtube.com/watch?v=ea7lJkEhytA
*/

#define MAX_STR_LENGTH 1024*1024*8

void reset_str(char *str)
{
  for (size_t i = 0; (i < MAX_STR_LENGTH) || (str[i] != 0); ++i) str[i] = 0;
}
